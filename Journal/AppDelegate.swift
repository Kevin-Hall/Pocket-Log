...
//  Journal
//
//  Created by Kevin Hall on 4/1/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        nc.post(name: NSNotification.Name(rawValue: "willClose"), object: nil)
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Journal", withExtension: "momd")!
